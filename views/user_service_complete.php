...
<body>
  <header>
    <div class="mynav">
	 ...
	 <a class="btn btn-outline-info" href="user_service_status.php">Requested Service</a>
	 <a class="btn btn-outline-info" href="user_service_ongoing.php">Service Ongoing</a>
	 <a class="btn btn-outline-info active" href="user_service_complete.php">Serviced</a>
...
<table class="table  table-hover table-striped table-sm  my-3" id="service_request_data">
    <thead>
      <tr>
        ...
        <th>Serviced Item</th>
        <th>Serviced By</th>
        <th>Maintainer's Note</th>
      </tr>
    </thead>
		<tbody>
		<?php
				foreach($serviceds as $serviced)
				{
					echo "<tr>";
						echo "<td>".$serviced["car_detail"]."</td>";
						echo "<td>".$serviced["engine_type"]." ".$serviced["drivetrain"]."</td>";
						echo "<td>".$serviced["engine_no"]."</td>";
						echo "<td>".$serviced["registration_no"]."</td>";
						echo "<td>".$serviced["service_needed"]."</td>";
						echo "<td>".$serviced["message"]."</td>";
						echo "<td>".$serviced["request_service_date"]."</td>";
						echo "<td>".$serviced["last_serviced_date"]."</td>";
						echo "<td>".$serviced["last_serviced_odo"]."</td>";
            echo "<td>".$serviced["last_serviced_item"]."</td>";
            echo "<td>".$serviced["serviced_by"]."</td>";
            echo "<td>".$serviced["mechanic_message"]."</td>";
					echo "</tr>";
				}
			?>
			</tbody>
