...
$underservices = getUnderServices();
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <header>
    <div class="mynav">
	 ...
	 <a class="btn btn-outline-info active" href="user_service_ongoing.php">Service Ongoing</a>
...
<table class="table  table-hover table-striped table-sm  my-3" id="service_request_data">
    <thead>
      <tr>
		...
		<tbody>
		<?php
				foreach($underservices as $underservice)
				{
					echo "<tr>";
						echo "<td>".$underservice["car_detail"]."</td>";
						echo "<td>".$underservice["engine_type"]." ".$underservice["drivetrain"]."</td>";
						echo "<td>".$underservice["engine_no"]."</td>";
						echo "<td>".$underservice["registration_no"]."</td>";
						echo "<td>".$underservice["service_needed"]."</td>";
						echo "<td>".$underservice["message"]."</td>";
						echo "<td>".$underservice["request_service_date"]."</td>";
						echo "<td>".$underservice["last_serviced_date"]."</td>";
						echo "<td>".$underservice["last_serviced_odo"]."</td>";
					echo "</tr>";
				}
			?>
			</tbody>
