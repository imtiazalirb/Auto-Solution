...
<h3 class="display-5 text-center my-4">Product Management</h3>
<div class="container">

  <form class="needs-validation" method="post" action="../controllers/.php" enctype="multipart/form-data" novalidate>
  <div class="form-row">
